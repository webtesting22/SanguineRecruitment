    ...
    return (
        <>
            <div className="Common-header margin-top-140px">
                <img src="https://s3.ap-south-1.amazonaws.com/prepseed/prod/ldoc/inventoryManagement/1035mWPLp6zXWlooG2Lz/678647f276cc20015e38cae1_Background pattern.png" alt="Decorative background pattern" loading="lazy" className="BackgrounCheckPatterImage" />
