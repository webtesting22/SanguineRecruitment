const ServicesCardsContent = [
    {
        ...
        mainPoints: [
            {
                title: "Technical Expertise & Specialization",
                description: "Our team possesses deep knowledge of manufacturing processes and engineering disciplines, enabling us to identify candidates with the right technical skills and industry experience.",
                subPoints: [
            ...
            },
            {
                ...
                description: "We provide tailored recruitment solutions that address the specific needs of manufacturing companies, from startups to multinational corporations.",
                subPoints: [
                    "Customized talent acquisition strategies",
                    "Technical skill assessment and validation",
                    "Cultural fit evaluation for manufacturing environments",
                    "Compliance with industry standards and regulations",
                    "Ongoing support and performance monitoring",
                    "Scalable hiring solutions for growth phases"
                ]
            }
        ]
    },
    {
        ...
        mainPoints: [
            {
                title: "Supply Chain & Logistics Excellence",
                description: "We identify professionals who can optimize supply chain operations, reduce costs, and improve delivery performance across complex logistics networks.",
                subPoints: [
            ...
            {
                title: "Retail Operations & Customer Experience",
                description: "Our recruitment focus extends to retail professionals who can enhance customer experience and drive sales performance in competitive markets.",
                subPoints: [
        ...
        mainPoints: [
            {
                ...
                description: "We identify technology professionals who can drive digital transformation and implement innovative solutions that give businesses a competitive edge.",
                subPoints: [
            ...
            },
            {
                ...
                description: "Our recruitment focus includes e-commerce specialists who can optimize online business operations and enhance digital customer experiences.",
                subPoints: [
...
export default ServicesCardsContent;
